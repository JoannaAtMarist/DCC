...
//This is altered from original AList.java
...
public class AList<T> implements ListInterface<T>
{
	...
	/**
	 * A constructor that creates a list from a given array of objects.
	 * @param anArray
	 */
	public AList(T[] anArray)
	{
		integrityOK = false;
		numberOfEntries = 0;
		...
		// Add objects from array to list
		for (int i = 0; i <anArray.length; i++)
		{
			tempList[i+1] = anArray[i];
			numberOfEntries++;
		}
	...
	/**
	 * Finds the position of a given object
	 * @param anObject
	 * @return the position of a given object in the list, 
	 * 		where T is the generic type of the objects in the list
	 */
	public int getPosition(T anObject)
	{
		//I made this in gift registry?
		for (int i = 0; i < getLength(); i++) {
			if (getEntry(i + 1).equals(anObject)) {
				return i+1;
			}
		}
		return -1; //  not found
